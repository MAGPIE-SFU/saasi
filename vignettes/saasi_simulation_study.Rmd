...
In contrast, standard tools are not designed to account for differences in sampling. Inferring ancestral states with `ace`:
...
```{r plots, fig.show='hold', fig.ncol=3,fig.width=4,fig.height=6, out.width="30%"}
