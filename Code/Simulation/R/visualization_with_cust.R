...
# RDS
d <- readRDS("Code/Results/1000_sims_onefourth.rds")
p1 <- ggplot(d, aes(x = method, y = accuracy)) +
  geom_violin(alpha = 0.5, fill = "lightblue", bw = 0.05, width = 0.8, scale = "width") +
  scale_x_discrete(limits = c("ACE", "PastML","SIMMAP", "TreeTime_1.0", "TreeTime_Custom",
                              "SAASI", "SAASI_pars"),
                   labels = c("ace", "PastML", "simmap","TreeTime", "TreeTime\n(Correction)",
                              "SAASI", "SAASI*")) +
...
p2 <- ggplot(d, aes(x = method, y = prob_accuracy)) +
  geom_violin(alpha = 0.5, fill = "lightcoral", bw = 0.05, width = 0.8, scale = "width") +
  scale_x_discrete(limits = c("ACE", "PastML", "SIMMAP","TreeTime_1.0", "TreeTime_Custom",
                              "SAASI", "SAASI_pars"),
                   labels = c("ace", "PastML", "simmap","TreeTime", "TreeTime\n(Correction)",
                              "SAASI", "SAASI*")) +
